...
InfiniteSource(DATA \<
		...
		77 c3       // Checksum
		c0 a8 01 91 // Source IP Address: 192.168.1.145
...
//autoupdate_Count::Script(TYPE PASSIVE, return '(all)'$(c1.count) '= (other)'$(otherIP_counter.count) '+ (proper)'$(p/c.count)) ; // Use this Script to print out the Counter when route stops
